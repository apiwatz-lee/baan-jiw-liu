      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 flex flex-col gap-3">
          ...
          <p className="text-sm sm:text-base text-[#6B4F3A]/70 leading-relaxed font-medium">
            นัดเวลาเข้าชมห้องจริง ลงทะเบียนสอบถามสิทธิ์ห้องว่าง หรือแชทคุยกับแม่บ้านได้โดยตรง
            เราพร้อมให้คำแนะนำในทุกรายละเอียด
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            >
              {isSubmitted ? (
                <div className="flex flex-col items-center justify-center text-center py-16 gap-4.5 my-auto">
                  ...
                  <h3 className="text-xl font-bold text-[#6B4F3A]">ส่งข้อมูลสำเร็จเรียบร้อย</h3>
                  <p className="text-sm text-[#6B4F3A]/70 max-w-xs leading-relaxed">
                    เจ้าหน้าที่ได้รับคำขอจอง/สอบถามของคุณแล้ว จะเร่งติดต่อกลับผ่านเบอร์โทรศัพท์โดยเร็วที่สุดค่ะ
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-5.5 w-full">
                  <h3 className="text-lg font-bold text-[#6B4F3A] mb-1">ฟอร์มส่งคำขอสอบถาม</h3>
                  
                  {/* Name Input */}
                  <div className="flex flex-col gap-2 text-left">
                    <label htmlFor="name" className="text-xs font-bold text-[#6B4F3A]/70 uppercase tracking-wider">
                      ชื่อ-นามสกุลของคุณ
                    </label>
                    <input
                      id="name"
                  ...
                  {/* Phone Input */}
                  <div className="flex flex-col gap-2 text-left">
                    <label htmlFor="phone" className="text-xs font-bold text-[#6B4F3A]/70 uppercase tracking-wider">
                      เบอร์โทรศัพท์ติดต่อ
                    </label>
                    <input
                      id="phone"
                  ...
                  {/* Room Selection */}
                  <div className="flex flex-col gap-2 text-left">
                    <label htmlFor="roomType" className="text-xs font-bold text-[#6B4F3A]/70 uppercase tracking-wider">
                      ห้องพักที่สนใจ
                    </label>
                    <select
                      id="roomType"
                  ...
                  {/* Message Input */}
                  <div className="flex flex-col gap-2 text-left">
                    <label htmlFor="message" className="text-xs font-bold text-[#6B4F3A]/70 uppercase tracking-wider">
                  ...
                  {/* Submit Button */}
                  <Button type="submit" variant="primary" className="w-full py-4.5 rounded-2xl mt-2 flex items-center justify-center gap-2">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-[#6B4F3A]/60 font-bold uppercase tracking-wider">โทรสายตรง</span>
                  <span className="text-xs font-bold text-[#6B4F3A]">{BRAND_INFO.phone}</span>
                </div>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-3 bg-[#F5EFE6]/50 border border-[#D8C4B6]/20 p-5 rounded-2xl hover:border-[#06C755] hover:bg-white transition-all duration-300 group shadow-sm text-left"
              >
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-[#6B4F3A]/60 font-bold uppercase tracking-wider">LINE แชท</span>
                  <span className="text-xs font-bold text-[#6B4F3A]">{BRAND_INFO.lineId}</span>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 bg-[#F5EFE6]/50 border border-[#D8C4B6]/20 p-5 rounded-2xl shadow-sm text-left">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] text-[#6B4F3A]/60 font-bold uppercase tracking-wider">Facebook</span>
                  <span className="text-xs font-bold text-[#6B4F3A]">{BRAND_INFO.facebook}</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex-grow min-h-[300px] w-full rounded-[36px] overflow-hidden border border-[#D8C4B6]/25 shadow-sm shadow-[#6B4F3A]/5 bg-stone-100">
              ...
              <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm px-4.5 py-3 rounded-full flex items-center gap-2 shadow-md border border-[#D8C4B6]/20">
                <MapPin className="w-4 h-4 text-[#C8A97E]" />
                <span className="text-xs font-bold text-[#6B4F3A]">100 เมตร จาก MRT ภาษีเจริญ</span>
              </div>
            </div>
          </motion.div>
        </div>
