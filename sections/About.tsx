        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-16 items-center'>
          ...
          >
            ...
            >
              <p className='text-xs font-medium italic text-[#D8C4B6]'>
                "ชอบทานมื้อเช้าที่คาเฟ่ใต้ตึกมากค่ะ ขนมอร่อย กาแฟดีมาก
                ไม่ต้องไปคาเฟ่ไกลๆ เลย"
              </p>
          ...
          <div className='lg:col-span-6 flex flex-col gap-6 text-left'>
            ...
            <p className='text-[#6B4F3A]/80 leading-relaxed text-base'>
              <strong>“บ้านจิ๋วหลิว”</strong>{' '}
              ถูกออกแบบขึ้นภายใต้แนวคิดหอพักหญิงที่มอบความอุ่นใจ ปลอดภัย
              และสะดวกสบายขั้นสุด
              เราเชื่อว่าที่อยู่อาศัยที่ดีไม่เพียงแต่ใช้สำหรับนอนพักผ่อน
              แต่ต้องมอบบรรยากาศและสุนทรียภาพในการใช้ชีวิตที่รื่นรมย์
            </p>

            <p className='text-[#6B4F3A]/80 leading-relaxed text-base'>
              จุดเด่นของเรานอกจากทำเลที่ห่างจากสถานีรถไฟฟ้า{' '}
              <strong>MRT ภาษีเจริญ เพียง 100 เมตร</strong> แล้ว
              เรายังมีพื้นที่พักผ่อนหย่อนใจใต้อาคารในรูปแบบ{' '}
              <strong>คาเฟ่สไตล์โฮมมี่</strong>
              ที่ให้บริการชากาแฟ เครื่องดื่ม
              และเมนูแสนอร่อยเพื่อซัพพอร์ตไลฟ์สไตล์วันทำงานและวันเรียบง่ายของคุณ
            </p>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4'>
              <GlassCard
                hoverEffect={true}
                className='p-4 rounded-2xl border-none bg-[#F5EFE6]/60'
                delay={0.1}
              >
                ...
                <h4 className='text-sm font-bold text-[#6B4F3A] mb-1'>
                  ปลอดภัยสูง
                </h4>
