...
export default function FloatingLine() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-[#06C755] text-white px-4.5 py-4.5 rounded-full shadow-xl hover:bg-[#05b04b] transition-all duration-300 group"
