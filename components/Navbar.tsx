        ...
        <div className='max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between'>
            ...
            {NAV_LINKS.map((link) => {
              ...
              return (
                <a
                  ...
                  className={cn(
                    'relative text-sm font-medium transition-colors duration-300 py-1.5 min-w-fit',
                    isActive
                      ? 'text-[#6B4F3A]'
                      : 'text-[#6B4F3A]/70 hover:text-[#6B4F3A]',
                  )}
                >
                  {link.label}
                  {isActive && (
          ...
          <div className='hidden lg:flex items-center gap-4'>
            <a
              ...
              className='flex items-center gap-2 text-sm font-semibold text-[#6B4F3A] hover:text-[#C8A97E] transition-colors duration-300 min-w-fit'
            >
